...
# NiFi API base URL
nifi_host = 'http://localhost:8080/nifi-api'

id="568195d1-0190-1000-e468-ce3f8fb37d78"
def get_process_group_status(group_id):
...
if __name__ == "__main__":
    ...
    """fadi=get_nifi_flow(NIFI_API_URL)
    print(fadi['processGroupFlow']['flow']['processGroups'][0])
    print(is_process_group_running(fadi['processGroupFlow']['flow']['processGroups'][0]))
    id=fadi['processGroupFlow']['flow']['processGroups'][0]['id']
    start_process_group(NIFI_API_URL,id)"""
 ...
 kafka_consumer :
  ...
  kafka_producer :
      ...
      networks:
        - kafka 
      volume :
      - ./db_resources:/opt/nifi/nifi-current/lib/postgresql-42.7.2.jar
"""